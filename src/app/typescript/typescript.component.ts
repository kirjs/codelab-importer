...
import {javaScriptWithConsoleLog, typeScriptWithConsoleLog} from './helpers/helpers';
import {extractMessages} from "./helpers/i18n-tools";
...
export class TypeScriptComponent implements OnInit {
  ...
  @ViewChild('translations', {static: true}) translation: any;
